...
import 'package:modul_cam_qr_0299/utils/logging_utils.dart';
import 'package:modul_cam_qr_0299/views/camera/display_picture.dart';
        ...
        MaterialPageRoute(
          builder: (context) {
            ...
            LoggingUtils.logDebugValue(
                "get image on previewImageResult".toLowerCase(),
